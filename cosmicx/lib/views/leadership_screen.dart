...
class _LeaderboardScreenState extends State<LeaderboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: _userRepo.watchLeaderboard(),
      builder: (context, leadersSnapshot) {
        ...
        final leaders = leadersSnapshot.data ?? <Map<String, dynamic>>[];
        ...
        return StreamBuilder<int>(
          stream: _userRepo.watchUserScore(),
          builder: (context, scoreSnapshot) {
            final myScore = scoreSnapshot.data ?? 0;
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              // 2nd Place
                              if (leaders.length > 1)
                                _buildPodiumItem(leaders[1], 2, 70),
                              const SizedBox(width: 12),
                              // 1st Place (Bigger)
                              _buildPodiumItem(leaders[0], 1, 90),
                              const SizedBox(width: 12),
                              // 3rd Place
                              if (leaders.length > 2)
                                _buildPodiumItem(leaders[2], 3, 70),
                            ],
                          ),
                        ],
                      ),
